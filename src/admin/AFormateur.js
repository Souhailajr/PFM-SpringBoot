...
function createData(image,firstname,lastname,competence,username,ville,phone,outside,options) {
  //const density = population / size;
  return {image,firstname,lastname,competence,username,ville,phone,outside,options};
}


export default function AFormateur() {
 ...
 const Options = (data)=> (
    <div className='flex justify-center items-center space-x-[-5px]'>
                    ...
                    <Link to={`/admin/formateurs/${data.id}/editer`}>
                    ...
                    <VisibilityIcon />
                     ...
                     <DeleteFormateur value={{data,alert,setUpdate}}/>
                  </div>
) 
  ...
  return (
   <div >
     <Box sx={{display:'flex' ,marginLeft:5,marginTop:4,marginBottom:4}}>
      <Link to={`/admin/formateurs/ajouter`} className='me-3'> 
