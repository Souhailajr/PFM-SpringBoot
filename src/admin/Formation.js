...
import CustomizedMenus from './anotherOptions/CustomizedMenus';
...
function createData(image,name,cout,programme,ville,date,entreprises,formateur,options) {
  //const density = population / size;
  return {image, name,cout,programme,ville,date,entreprises,formateur,options};
}
...
export default function Formation() {
 ...
 const Options = (data)=> (
    <div className='flex justify-center items-center space-x-[-5px]'>
                    ...
                    <Link to={`/admin/formations/${data.id}/editer`}>
                    <IconButton aria-label="modifier">
                    <DriveFileRenameOutlineIcon />
                    </IconButton>
                    </Link>
                    <CustomizedMenus datas={{data,alert,setUpdate}} />
                    ...
                    <DeleteFormation value={{data,alert,setUpdate}}/>
                  </div>
) 
  ...
  return (
   <div >
     <Box sx={{display:'flex' ,marginLeft:5,marginTop:4,marginBottom:4}}>
      <Link to="/admin/formations/ajouter" className='me-3'> 
